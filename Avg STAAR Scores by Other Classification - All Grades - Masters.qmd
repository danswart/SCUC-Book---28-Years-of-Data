---
title: "Avg STAAR Scores by Other Classification - All Grades - Masters"
...
##  Avg STAAR Scores by Other Classification - All Grades - Masters
...
subtitle <- paste0("In Grades - ",
    ...
    plot <- plot +
      scale_y_continuous(labels = scales::percent_format(scale = 1, accuracy = 1),
       ...
       annotate("text",
               x = Inf,
               y = 40,  # place it in the lower portion of the plot
...
![](png_Standardized_Scores/Standardized_ScoresEconomicallyDisadvantagedscoreAllMasters19952022.png)