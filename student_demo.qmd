...
#   gganimate::anim_save(
#     filename = "student_body_animation.gif",
#     path = "gif",
#     student_body,
#     nframes = 300,
#           fps = 30,
...
```{r, echo=FALSE, eval=knitr::is_html_output(), animate=animate::animate}

knitr::include_graphics("gif/student_body_animation.gif")
