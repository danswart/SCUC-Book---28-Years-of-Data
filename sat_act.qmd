...
#####  STEP 1 - CREATE MULTIPLE 1-LINE STATIC PLOTS
...
# 
# # Specify desired dates (years)
# desired_years <- unique(first_df$date)
# 
...
#                      )
# 
# # Create the chart with qicharts2, then theme it below
# #
# plot <- qic(
#   x = df_group$date,
#   y = df_group$value,
...
#####  END OF STEP 1 - CREATE MULTIPLE 1-LINE STATIC PLOTS

```


<!-- UNCOMMENT THIS SECTION AND RUN IT TO PRINT LIST OF -->
<!-- THE PNG FILES INTO THE CONSOLE FOR COPY AND PASTE  -->
<!-- (INDEPENDENTLY OF WHAT IS IN THESPECIFIED PNG STORAGE FOLDER) -->
<!-- -->
...
## STEP 2 - START FROM SCRATCH AND CREATE LIST OF PNG FILES
## GENERATED ABOVE FOR COPY AND PASTE FROM CONSOLE TO BODY OF QUARTO DOC
## CLEAR THE CONSOLE, THEN RUN THE CODE BELOW
...
# desired_units <- unique(first_df$units)
# 
# # Specify desired years (column is labeled 'date' in dataframe)
# desired_years <- unique(first_df$date)
# 
# # Specify desired grade level
# desired_grades <- unique(first_df$grade)
...
##### END OF STEP 2 - START FROM SCRATCH AND CREATE LIST OF PNG FILES
##### CUT AND PASTE THE CONSOLE OUTPUT INTO THE MARKDOWN TEXT AREA BELOW
...
![](png_SAT_ACT/SAT_ACTPercentTestedpercent_of_studentsAllNA19952022.png)
...
![](png_SAT_ACT/SAT_ACTPercentAtOrAboveCriterionpercent_of_studentsAllNA19952022.png)
...
![](png_SAT_ACT/SAT_ACTSAT-MeanTotalScorescoreAllNA19952022.png)
...
![](png_SAT_ACT/SAT_ACTACT-MeanCompositeScorescoreAllNA19952022.png)
