---
title: "Avg STAAR Scores by Ethnic Classification - All Grades - Masters"
...
<br>
##  Avg STAAR Scores by Ethnic Classification - All Grades - Meets or Above
...
generate_run_chart <- function(df_group, desired_years, desired_grades) {
  ...
  theme(plot.title.position = "panel",
        ...
        plot.title = element_text(color = "darkgreen",
                                                    ...
                                                    # family = "Roboto",
                                                    lineheight = 0.9,
                                                    margin = margin(0.5, 0, 0.25, 0, "lines"
                                                                    )
                                                    ),
        plot.subtitle = element_text(color = "darkorchid1",
                                     size = rel(1.10),
                                     face = "bold",
                                     lineheight = 0.8,
