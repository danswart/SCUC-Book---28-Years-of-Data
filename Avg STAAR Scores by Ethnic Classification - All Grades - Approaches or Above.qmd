---
title: "Avg STAAR Scores by TEA Ethnic Classification - All Grades - Approaches or Above"
...
# Display the plot ('plot' is a function inside a function, not a ggplot2 object)
# The last code snippet feeds data into the function that then executes this
# function and displays the plots in the Plots tab.

# This is the snippet below that triggers the generate_run_chart function
...
# You can print the individual plots either INSIDE the function (print(plot), or OUTSIDE
# the function (here) with print(plots)
print(plots)
